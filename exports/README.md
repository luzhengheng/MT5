...
**生成时间**: 2026-01-08T13:56:36.318575
**版本**: 20260108_135636
...
### 第 2 步：复制提示词
1. 打开 `AI_PROMPT_20260108_135636.md` ⭐
2. 复制全部内容
3. 粘贴到 AI 对话框
...
### 1. AI_PROMPT_20260108_135636.md ⭐ 最重要
**用途**: 复制到外部 AI 的提示词
...
### 2. CONTEXT_SUMMARY_20260108_135636.md
**用途**: 项目快速概览
...
### 3. git_history_20260108_135636.md
**用途**: Git 提交历史
...
### 4. project_structure_20260108_135636.md
**用途**: 项目目录结构
...
### 5. core_files_20260108_135636.md
**用途**: 核心代码文件
...
### 6. documents_20260108_135636.md
**用途**: 项目文档
...
2. 新建对话
3. 粘贴 `AI_PROMPT_20260108_135636.md` 的全部内容
...
1. 先发送 `AI_PROMPT_20260108_135636.md`
2. 等待 AI 确认理解
3. 发送 `CONTEXT_SUMMARY_20260108_135636.md`
4. 发送 `core_files_20260108_135636.md`
5. 发送 `documents_20260108_135636.md`
6. 按需发送其他文件
...
### 4. 保存完整结果
- 将 AI 的评估完整保存
- 建议保存位置: `exports/ai_reviews/gemini_review_20260108.md`
- 可以多次参考
...
```
exports/ai_reviews/
├── gemini_review_20260108.md
├── claude_review_20260108.md
└── chatgpt_review_20260108.md
```
...
*生成时间: 2026-01-08T13:56:36.318633*
*版本: 20260108_135636*
